...
//tippyOptions.triggerTarget = $(td).closest('tr')[0]
tippy(e.find('span')[0],i)):'success'!==s.status||s.meta.warnings&&s.meta.warnings.length?'success'===s.status&&s.meta.warnings.length&&(e.find('span').append('<span class="dashicons dashicons-warning"></span>'),tippy(e.find('span')[0],i)):(l=s.meta&&s.meta.stats&&0<s.meta.stats.success_count||0<Number(s.success_count)?'hits-success':'',e.find('span').append('<span class="dashicons dashicons-yes-alt '+l+'"></span>'),tippy(e.find('span')[0],i))}},{data:"meta",visible:!1,render:function(e,t,s,a){return e&&e.warnings&&0<e.warnings.length?'warning':e.status}},{data:"url",className:'dt-body-right dt-head-right action th-actions',targets:0,title:"Actions",width:'60px',render:function(e,t,s,a){var n='';return(n+='<button data-uucss-optimize data-url="'+e+'" data-rule="'+s.rule+'" data-rule_id="'+s.id+'" data-regex="'+s.regex+'"><span class="dashicons dashicons-update"></span></button>')+('<button data-uucss-options data-url="'+e+'" data-rule="'+s.rule+'" data-regex="'+s.regex+'"><span class="dashicons dashicons-ellipsis"></span></button>')}}],rowCallback:function(u,c,e,t,r){tippy(C(u).find('button[data-uucss-options]')[0],{allowHTML:!0,trigger:'click',arrow:!0,appendTo:C(u).find('button[data-uucss-options]')[0],interactive:!0,animation:'shift-toward',hideOnClick:!0,theme:'light',content:()=>{var e=C('<div class="uucss-option-list"><ul class="option-list"></ul></div>');return e.find('ul').append('<li data-action_name="edit_rule"><a data-action_name="edit_rule" href="#" data-url="'+c.url+'" data-rule="'+c.rule+'" data-regex="'+c.regex+'" data-index="'+r+'">Edit</a></li>'),e.find('ul').append('<li data-action_name="duplicate_rule"><a data-action_name="duplicate_rule" href="#" data-url="'+c.url+'" data-rule="'+c.rule+'" data-regex="'+c.regex+'" data-index="'+r+'">Duplicate</a></li>'),'queued'!==c.status&&(e.find('ul').append('<li data-action_name="requeue_rule"><a data-action_name="requeue_rule" href="#" data-url="'+c.url+'" data-rule="'+c.rule+'" data-regex="'+c.regex+'" data-index="'+r+'">Requeue</a></li>'),window.uucss)&&"1"===window.uucss.cpcss_enabled&&e.find('ul').append('<li data-action_name="regenerate_cpcss"><a data-action_name="regenerate_cpcss" href="#" data-url="'+c.url+'" data-rule="'+c.rule+'" data-regex="'+c.regex+'" data-index="'+r+'">Regenerate Critical CSS</a></li>'),'success'===c.status&&e.find('ul').append('<li data-action_name="test"><a data-action_name="test" href="#" data-url="'+c.url+'" data-rule="'+c.rule+'" data-regex="'+c.regex+'" data-index="'+r+'">GPSI Status</a></li>'),"1"===C('#thirtd_part_cache_plugins').val()&&e.find('ul').append('<li data-action_name="purge-url"><a data-action_name="purge-url" data-rule="'+c.rule+'" data-regex="'+c.regex+'" href="#" data-url="'+c.url+'" data-index="'+r+'">Clear Page Cache</a></li>'),e.find('ul').append('<li data-action_name="remove"><a data-action_name="remove" href="#" data-url="'+c.url+'" data-rule="'+c.rule+'" data-regex="'+c.regex+'" data-index="'+r+'">Remove</a></li>'),e.find('ul').append('<li data-action_name="preview"><a data-action_name="preview" target="_blank" href="'+c.url+'">Preview</a></li>'),e.wrap('<div></div>').parent().html()},onClickOutside(e,t){e.hide()},onCreate(){tippy(C('.uucss-option-list ul.option-list li[data-action_name="remove"]')[0],{content:'Remove RapidLoad cache files',allowHTML:!0,placement:'left',hideOnClick:!1,animation:null,interactive:!0,delay:0,inlinePositioning:!0,maxWidth:500,appendTo:'parent'}),tippy(C('.uucss-option-list ul.option-list li[data-action_name="test"]')[0],{content:'Test Url',allowHTML:!0,placement:'left',hideOnClick:!1,animation:null,interactive:!0,delay:0,inlinePositioning:!0,maxWidth:500,appendTo:'parent'})},onMount(e){C('.uucss-option-list ul.option-list li a').off().click(function(e){var t=C(this),s=t.data('action_name'),a=t.data('rule'),n=t.data('regex'),i=t.data('url');switch(s){case'preview':var l=C(this).attr('href').toString();window.open(l+(l.includes("?")?"&":"?")+"rapidload_preview_optimization","_blank");break;case'requeue_rule':v('current',{url:i,rule:a,regex:n},null,'rule');break;case'regenerate_cpcss':wp.ajax.post('cpcss_purge_url',{url:i,nonce:window.uucss.nonce}).then(function(e){C.uucssAlert(e,'success')}).fail(function(e){C.uucssAlert(e,'error')});break;case'duplicate_rule':C.featherlight(C('#add_rule_featherlight_content'),{variant:'add-site-rule-model',afterOpen:function(){this.$content.find('#model-uucss-rules').val(a),this.$content.find('input.rule-base-url').val(i),this.$content.find('input.rule-url-regex').val(n)}});break;case'edit_rule':C.featherlight(C('#add_rule_featherlight_content'),{variant:'add-site-rule-model',afterOpen:function(){this.$content.find('#model-uucss-rules').val(a),this.$content.data('old_rule',a),this.$content.find('input.rule-base-url').val(i),this.$content.data('old_base_url',i),this.$content.find('input.rule-url-regex').val(n),this.$content.data('old_rule_regex',n)}});break;case'remove':w(c.url,!0,u,r,c,{rule:a,regex:n})
/*wp.ajax.post('rapidload_purge_all',{
                                        job_type : 'rule',
                                        rule : rule,
                                        regex : regex,
...
x=C('input.site-map-url'),wp.ajax.post('get_robots_text',{nonce:window.uucss.nonce}).done(function(e){e&&e.sitemap&&x.data('sitemap_url',e.sitemap)})})}(jQuery);