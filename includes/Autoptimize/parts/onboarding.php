        ...
        <div class="steps-wrap">
            <div class="step-text">
                <?php
                    ...
                    if( is_plugin_active('autoptimize/autoptimize.php') && class_exists('autoptimizeOptionWrapper')){
            ...
            <div class="slide-contents-wrap">
                ...
                ?>">
                    <div class="actions slide-content">
                        ...
                        <a class="act-button js-activate-ao <?php echo is_plugin_active('autoptimize/autoptimize.php') ? 'done' : null ?>"
                           href="<?php
