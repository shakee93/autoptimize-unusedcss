...
class UnusedCSS_RapidLoad_Onboard{
    use RapidLoad_Utils;
    ...
    static function on_board_completed(){
        return UnusedCSS_Admin::is_api_key_verified();;
    }
    ...
    function get_on_board_steps(){
        ...
        $steps = apply_filters('rapidload/on-board/steps', [
            [
                ...
                'render' => function(){
                    ?>
                    <div class="connect actions slide-content <?php if (UnusedCSS_Admin::is_api_key_verified()) { echo 'done'; } ?>">
                        ...
                        <div class="action-wrap">
                            <a class="skip-analyze js-uucss-connect"
                               href="<?php echo RapidLoad_Utils::activation_url( "authorize", 'options-general.php?page=rapidload-onboarding' ) ?>">Skip
                                & Connect</a>
                            <a class="act-button <?php echo UnusedCSS_Admin::is_api_key_verified() ? 'js-uucss-connect' : 'js-uucss-analyze-site' ?> "
                               data-activation_url="<?php echo RapidLoad_Utils::activation_url( "authorize", 'options-general.php?page=rapidload-onboarding' ) ?>"
                               href="#"
                               target="_blank">
                                <?php echo UnusedCSS_Admin::is_api_key_verified() ? 'Connect' : 'Analyze' ?>
            ...
            [
                ...
                'class' => 'connect actions slide-content',
                'done_callback' => function(){
                    return RapidLoad_Settings::get_first_link();
                },
                'render' => function(){
                    ?>
                    <div class="run-job actions slide-content <?php if (RapidLoad_Settings::get_first_link()) { echo 'done'; } ?>">
                        <h2>Run First Job</h2>
                        <div class="action-content">
