                    ...
                    if(!sampleData){
                        $.ajax({
                            ...
                            success : function (result){
                                var opportunities = [];
                                Object.keys(result.page_matrix.lighthouseResult.audits).map(function(key) {
                                    if(result.page_matrix.lighthouseResult.audits[key].details && result.page_matrix.lighthouseResult.audits[key].details.type === "opportunity"){
                                        opportunities.push(result.page_matrix.lighthouseResult.audits[key])
                                    }
                                } )
