        ...
        <div class="flex mt-1">
          <div>
            <div class="inline-flex">
              <h1 class="font-medium text-base text-black-font">Page Cache</h1>
            ...
            <p class="text-sm text-gray-font">Optimize and cache static HTML pages to provide a snappier page experience.</p>
          </div>
        </div>
      </div>
