          ...
          <div class="grid mb-5">
            ...
            <div class="flex">
              ...
              <input :class="{ 'pointer-events-none	cursor-default disabled': !devmode }"
                     ...
                     class="resize-none text-xs z-50 appearance-none border gray-border rounded-l-lg w-full py-2 px-3 h-[2.5rem] text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
