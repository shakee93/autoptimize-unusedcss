        ...
        <div class="flex mt-1">
          <div>
            ...
            <div class="inline-flex">
              ...
              <a :href="'https://docs.rapidload.io/features/cloud-delivery'" class="focus:outline-none" target="_blank">
        ...
        <div class="p-4 pl-32 pr-72">
          ...
          <div class="grid mb-5">
            ...
            <div class="flex">
              ...
              <div :class="copied ? 'rl-Show' : 'rl-Hide'" class="-mt-20 mr-6 px-2 mt-0.5 absolute -left-10" >
