...
<!--          </a>-->
      ...
      <div class="-mt-[55px] -ml-[70px]">
        ...
        <RouterLink :class="{disableBlock: !license_information.licensed_domain}"
                    ...
                    to="/settings">
          <svg height="25" viewBox="0 0 512 512" width="25" xmlns="http://www.w3.org/2000/svg" fill="#7F54B3"><path d="M262.29,192.31a64,64,0,1,0,57.4,57.4A64.13,64.13,0,0,0,262.29,192.31ZM416.39,256a154.34,154.34,0,0,1-1.53,20.79l45.21,35.46A10.81,10.81,0,0,1,462.52,326l-42.77,74a10.81,10.81,0,0,1-13.14,4.59l-44.9-18.08a16.11,16.11,0,0,0-15.17,1.75A164.48,164.48,0,0,1,325,400.8a15.94,15.94,0,0,0-8.82,12.14l-6.73,47.89A11.08,11.08,0,0,1,298.77,470H213.23a11.11,11.11,0,0,1-10.69-8.87l-6.72-47.82a16.07,16.07,0,0,0-9-12.22,155.3,155.3,0,0,1-21.46-12.57,16,16,0,0,0-15.11-1.71l-44.89,18.07a10.81,10.81,0,0,1-13.14-4.58l-42.77-74a10.8,10.8,0,0,1,2.45-13.75l38.21-30a16.05,16.05,0,0,0,6-14.08c-.36-4.17-.58-8.33-.58-12.5s.21-8.27.58-12.35a16,16,0,0,0-6.07-13.94l-38.19-30A10.81,10.81,0,0,1,49.48,186l42.77-74a10.81,10.81,0,0,1,13.14-4.59l44.9,18.08a16.11,16.11,0,0,0,15.17-1.75A164.48,164.48,0,0,1,187,111.2a15.94,15.94,0,0,0,8.82-12.14l6.73-47.89A11.08,11.08,0,0,1,213.23,42h85.54a11.11,11.11,0,0,1,10.69,8.87l6.72,47.82a16.07,16.07,0,0,0,9,12.22,155.3,155.3,0,0,1,21.46,12.57,16,16,0,0,0,15.11,1.71l44.89-18.07a10.81,10.81,0,0,1,13.14,4.58l42.77,74a10.8,10.8,0,0,1-2.45,13.75l-38.21,30a16.05,16.05,0,0,0-6.05,14.08C416.17,247.67,416.39,251.83,416.39,256Z"/></svg>
        </RouterLink>
      </div>

      <div class="-mt-[55px] -ml-[80px]">
        <a :class="{disableBlock: !license_information.licensed_domain}"
           class="genral-settings bg-transparent transition duration-300 rounded-full px-2 py-2 text-center inline-flex items-center"
           :href="docs" target="_blank">
          <!--          <svg xmlns="http://www.w3.org/2000/svg" fill="#7F54B3" viewBox="0 0 13 13" height="25" width="25">-->
          ...
          <!--          </svg>-->
          <p class="mb-1 mt-1 text-xm text-black leading-db-lh">Doc</p>
        </a>
      </div>
      <div class="-mt-[55px] -ml-[120px]">
        <a :class="{disableBlock: !license_information.licensed_domain}"
           class="genral-settings bg-transparent transition duration-300 rounded-full px-2 py-2 text-center inline-flex items-center"
           :href="docs" target="_blank">
          <!--          <svg xmlns="http://www.w3.org/2000/svg" fill="#7F54B3" viewBox="0 0 13 13" height="25" width="25">-->
          ...
          <!--            <path d="M5.4043 7.15302C5.41158 7.11525 5.41521 7.07686 5.41515 7.03839C5.41515 7.01872 5.41515 6.9994 5.41244 6.98074C5.41449 6.99989 5.41551 7.01914 5.41549 7.03839C5.41561 7.07688 5.41186 7.11528 5.4043 7.15302Z"/>-->
          <!--          </svg>-->
          <p class="mb-1 mt-1 text-xm text-black leading-db-lh">Feedback</p>
        </a>
      </div>
    </div>
