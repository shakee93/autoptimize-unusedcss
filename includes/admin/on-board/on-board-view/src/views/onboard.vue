  ...
  <main>
    <div class="flex">
      ...
      <div class="ml-20 -mt-20">
        ...
        <div v-if="!loading" :class="!loading? 'enter-from':'rl-Hide'">
        ...
        <div class="w-[770px] h-[505px] drop-shadow-sm rounded-[40px] border border-gray-border-line bg-white">
          ...
          <div v-if="count===1" class="m-12 mt-11 mb-1 transition duration-300">
            ...
            <div v-if="loading" :class="loading? 'enter-from block':'hidden'" class="m-12 mt-11 mb-1 transition duration-300 ">
          ...
          <div v-if="count===2 && !loading" :class="!loading? 'enter-from block':'hidden'" class="m-12 mt-11 mb-1 transition duration-300">
            <div class="max-h-[356px] min-h-[356px] grid h-screen place-items-center">
          ...
          <div v-if="count===3 && !loading" :class="!loading? 'enter-from block':'hidden'" class="m-12 mt-11 mb-1 transition duration-300">
          ...
          <div v-if="count===4 && !loading" :class="!loading? 'enter-from block':'hidden'" class="m-12 mt-11 mb-1 transition duration-300">
          ...
          <div v-if="!loading" class="dotstyle dotstyle-dotmove place-content-center place-items-center flex">
            <ul>
        ...
        <div class="mt-10 ml-4 mb-4 min-h-[58px]">
          <div v-if="!loading" class="grid place-content-center place-items-center">
